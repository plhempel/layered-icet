...
#define ICET_COMPOSITE_ROUND_TIME   (ICET_STATE_TIMING_START | (IceTEnum)0x000B)
...
#define ICET_COMPOSITE_ROUND_START_TIME (ICET_STATE_TIMING_START | (IceTEnum)0x0014)
#define ICET_COMPOSITE_ROUND_TIME_ID    (ICET_STATE_TIMING_START | (IceTEnum)0x0015)
